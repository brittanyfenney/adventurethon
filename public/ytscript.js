 ...
 */
 ...
 function b(n){for(var r=g,q=0;64>q;q+=4)r[q/4]=n[q]<<24|n[q+1]<<16|n[q+2]<<8|n[q+3];for(q=16;80>q;q++)n=r[q-3]^r[q-8]^r[q-14]^r[q-16],r[q]=(n<<1|n>>>31)&4294967295;n=e[0];var x=e[1],v=e[2],w=e[3],N=e[4];for(q=0;80>q;q++){if(40>q)if(20>q){var F=w^x&(v^w);var P=1518500249}else F=x^v^w,P=1859775393;else 60>q?(F=x&v|w&(x|v),P=2400959708):(F=x^v^w,P=3395469782);F=((n<<5|n>>>27)&4294967295)+F+N+P+r[q]&4294967295;N=w;w=v;v=(x<<30|x>>>2)&4294967295;x=n;n=F}e[0]=e[0]+n&4294967295;e[1]=e[1]+x&4294967295;e[2]=
 e[2]+v&4294967295;e[3]=e[3]+w&4294967295;e[4]=e[4]+N&4294967295}
 ...
 return a[md]}
 ;function M(){Ec.call(this);this.h=new Wc(this);this.D=this;this.o=null}
 ...
 Le.i();function Ne(a){var b=Oe;a=void 0===a?C("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=Wb;e.flash="0";a:{try{var f=b.h.top.location.href}catch(N){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?L:g;try{var h=g.history.length}catch(N){h=0}e.u_his=h;e.u_java=!!L.navigator&&"unknown"!==typeof L.navigator.javaEnabled&&!!L.navigator.javaEnabled&&L.navigator.javaEnabled();L.screen&&(e.u_h=L.screen.height,e.u_w=L.screen.width,
 e.u_ah=L.screen.availHeight,e.u_aw=L.screen.availWidth,e.u_cd=L.screen.colorDepth);L.navigator&&L.navigator.plugins&&(e.u_nplug=L.navigator.plugins.length);L.navigator&&L.navigator.mimeTypes&&(e.u_nmime=L.navigator.mimeTypes.length);h=b.h;try{var k=h.screenX;var l=h.screenY}catch(N){}try{var m=h.outerWidth;var n=h.outerHeight}catch(N){}try{var r=h.innerWidth;var q=h.innerHeight}catch(N){}k=[h.screenLeft,h.screenTop,k,l,h.screen?h.screen.availWidth:void 0,h.screen?h.screen.availTop:void 0,m,n,r,q];
 l=b.h.top;try{var x=(l||window).document,v="CSS1Compat"==x.compatMode?x.documentElement:x.body;var w=(new Ob(v.clientWidth,v.clientHeight)).round()}catch(N){w=new Ob(-12245933,-12245933)}x=w;w={};v=new hc;B.SVGElement&&B.document.createElementNS&&v.set(0);l=Vb();l["allow-top-navigation-by-user-activation"]&&v.set(1);l["allow-popups-to-escape-sandbox"]&&v.set(2);B.crypto&&B.crypto.subtle&&v.set(3);B.TextDecoder&&B.TextEncoder&&v.set(4);v=ic(v);w.bc=v;w.bih=x.height;w.biw=x.width;w.brdim=k.join();b=
 ...
 R("DELEGATED_SESSION_ID")&&!T("pageid_as_header_web")&&(b.user={onBehalfOfUser:R("DELEGATED_SESSION_ID")});a:{if(h=Qf()){a=Of[h.type||"unknown"]||"CONN_UNKNOWN";h=Of[h.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==h&&(a=h);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==h){a=h;break a}}a=void 0}a&&(b.client.connectionType=a);T("web_log_effective_connection_type")&&(a=Qf(),a=null!==a&&void 0!==a&&a.effectiveType?Pf.hasOwnProperty(a.effectiveType)?Pf[a.effectiveType]:
 ...
 function Sf(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||R("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.Ja||R("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Ia:b=gc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=R("SESSION_INDEX",0),T("pageid_as_header_web")&&(d["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));return d}
 ...
 ;function Uf(a){var b=new Qd;(b=b.isAvailable()?a?new Wd(b,a):b:null)||(a=new Rd(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.h=(a=b)?new Md(a):null;this.i=document.domain||window.location.hostname}
 Uf.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,Date.now()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(pd(b))}catch(f){return}else e=escape(b);b=this.i;dc.set(""+a,e,{S:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
 Uf.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=dc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
 Uf.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;dc.remove(""+a,"/",void 0===b?"youtube.com":b)};var Vf;function Wf(){Vf||(Vf=new Uf("yt.innertube"));return Vf}
 function Xf(a,b,c,d){if(d)return null;d=Wf().get("nextId",!0)||1;var e=Wf().get("requests",!0)||{};e[d]={method:a,request:b,authState:Tf(c),requestTime:Math.round(U())};Wf().set("nextId",d+1,86400,!0);Wf().set("requests",e,86400,!0);return d}
 function Yf(a){var b=Wf().get("requests",!0)||{};delete b[a];Wf().set("requests",b,86400,!0)}
 function Zf(a){var b=Wf().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=Tf(Sf(!1));Va(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),Lf(a,d.method,e,{}));delete b[c]}}Wf().set("requests",b,86400,!0)}}
 ;var $f=C("ytPubsub2Pubsub2Instance")||new Q;Q.prototype.subscribe=Q.prototype.subscribe;Q.prototype.unsubscribeByKey=Q.prototype.M;Q.prototype.publish=Q.prototype.J;Q.prototype.clear=Q.prototype.clear;E("ytPubsub2Pubsub2Instance",$f);E("ytPubsub2Pubsub2SubscribedKeys",C("ytPubsub2Pubsub2SubscribedKeys")||{});E("ytPubsub2Pubsub2TopicToKeys",C("ytPubsub2Pubsub2TopicToKeys")||{});E("ytPubsub2Pubsub2IsAsync",C("ytPubsub2Pubsub2IsAsync")||{});E("ytPubsub2Pubsub2SkipSubKey",null);var ag=[],bg=!1;function cg(a,b){bg||(ag.push({type:"EVENT",eventType:a,payload:b}),10<ag.length&&ag.shift())}
 ...
 ma(dg,Error);function eg(a){return a.substr(0,a.indexOf(":"))||a}
 ;var fg={},gg=(fg.AUTH_INVALID="No user identifier specified.",fg.EXPLICIT_ABORT="Transaction was explicitly aborted.",fg.IDB_NOT_SUPPORTED="IndexedDB is not supported.",fg.MISSING_OBJECT_STORE="Object store not created.",fg.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",fg.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",fg.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",fg.EXECUTE_TRANSACTION_ON_CLOSED_DB=
 "Can't start a transaction on a closed database",fg),hg={},ig=(hg.AUTH_INVALID="ERROR",hg.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",hg.EXPLICIT_ABORT="IGNORED",hg.IDB_NOT_SUPPORTED="ERROR",hg.MISSING_OBJECT_STORE="ERROR",hg.QUOTA_EXCEEDED="WARNING",hg.QUOTA_MAYBE_EXCEEDED="WARNING",hg.UNKNOWN_ABORT="WARNING",hg);
 function V(a,b,c,d){b=void 0===b?{}:b;c=void 0===c?gg[a]:c;d=void 0===d?ig[a]:d;dg.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a},b));this.type=a;this.message=c;this.level=d;Object.setPrototypeOf(this,V.prototype)}
 ma(V,dg);function jg(a){V.call(this,"MISSING_OBJECT_STORE",{Pa:a},gg.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,jg.prototype)}
 ma(jg,V);var kg=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
 function lg(a,b,c){b=eg(b);var d=a instanceof Error?a:Error("Unexpected error: "+a);if(d instanceof V)return d;if("QuotaExceededError"===d.name)return new V("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(Lb&&"UnknownError"===d.name)return new V("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===d.name&&kg.some(function(e){return d.message.includes(e)}))return new V("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
 dbName:b});if("AbortError"===d.name)return new V("UNKNOWN_ABORT",{objectStoreNames:c,dbName:b},d.message);d.args=[{name:"IdbError",Qa:d.name,dbName:b,objectStoreNames:c}];d.level="WARNING";return d}
 ...
 W.all=function(a){return new W(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={H:0};f.H<a.length;f={H:f.H},++f.H)og(W.resolve(a[f.H]).then(function(g){return function(h){d[g.H]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
 ...
 W.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:ng,e=null!==b&&void 0!==b?b:mg;return new W(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){pg(c,c,d,f,g)}),c.onRejected.push(function(){qg(c,c,e,f,g)})):"FULFILLED"===c.state.status?pg(c,c,d,f,g):"REJECTED"===c.state.status&&qg(c,c,e,f,g)})};
 function og(a,b){a.then(void 0,b)}
 function pg(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof W?rg(a,b,f,d,e):d(f)}catch(g){e(g)}}
 function qg(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof W?rg(a,b,f,d,e):d(f)}catch(g){e(g)}}
 function rg(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof W?rg(a,b,f,d,e):d(f)},function(f){e(f)})}
 ...
 function X(a){return new W(function(b,c){sg(a,b,c)})}
 ;function ug(a,b){return new W(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
 e()})}
 ;function vg(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(U());this.i=!1}
 p=vg.prototype;p.add=function(a,b,c){return wg(this,[a],{mode:"readwrite",I:T("ytidb_transaction_enable_retries_core_and_nwl")},function(d){return xg(d,a).add(b,c)})};
 p.clear=function(a){return wg(this,[a],{mode:"readwrite",I:T("ytidb_transaction_enable_retries_core_and_nwl")},function(b){return xg(b,a).clear()})};
 p.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
 p.count=function(a,b){return wg(this,[a],{mode:"readonly",I:T("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return xg(c,a).count(b)})};
 p["delete"]=function(a,b){return wg(this,[a],{mode:"readwrite",I:T("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return xg(c,a)["delete"](b)})};
 p.get=function(a,b){return wg(this,[a],{mode:"readonly",I:T("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return xg(c,a).get(b)})};
 function wg(a,b,c,d){return K(a,function f(){var g=this,h,k,l,m,n,r,q,x,v,w,N;return z(f,function(F){switch(F.h){case 1:var P={mode:"readonly",I:!1};"string"===typeof c?P.mode=c:P=c;h=P;g.transactionCount++;k=h.I?He("ytidb_transaction_try_count",1):1;case 2:if(l){F.h=3;break}k--;m=Math.round(U());F.m=4;n=g.h.transaction(b,h.mode);P=new yg(n);P=zg(P,d);return y(F,P,6);case 6:return r=F.i,q=Math.round(U()),Ag(g,m,q,void 0,b.join(),h),F["return"](r);case 4:x=qa(F);v=Math.round(U());w=lg(x,g.h.name,b.join());
 if((N=w instanceof V&&"EXPLICIT_ABORT"===w.type)||0>=k)Ag(g,m,v,w,b.join(),h),l=w;F.h=2;break;case 3:return F["return"](Promise.reject(l))}})})}
 function Ag(a,b,c,d,e,f){b=c-b;d?(d instanceof V&&("QUOTA_EXCEEDED"===d.type||"QUOTA_MAYBE_EXCEEDED"===d.type)&&cg("QUOTA_EXCEEDED",{dbName:eg(a.h.name),objectStoreNames:e,transactionCount:a.transactionCount,transactionMode:f.mode}),d instanceof V&&"UNKNOWN_ABORT"===d.type&&(cg("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:e,transactionDuration:b,transactionCount:a.transactionCount,dbDuration:c-a.j}),a.i=!0),Bg(a,!1,e,b),bg||(ag.push({type:"ERROR",payload:d}),10<ag.length&&ag.shift())):Bg(a,
 !0,e,b)}
 function Bg(a,b,c,d){cg("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.i,duration:d,isSuccessful:b})}
 function Cg(a){this.h=a}
 p=Cg.prototype;p.add=function(a,b){return X(this.h.add(a,b))};
 ...
 p["delete"]=function(a){return a instanceof IDBKeyRange?Dg(this,a):X(this.h["delete"](a))};
 p.get=function(a){return X(this.h.get(a))};
 p.index=function(a){return new Fg(this.h.index(a))};
 p.getName=function(){return this.h.name};
 function Eg(a,b,c){a=a.h.openCursor(b.query,b.direction);return Gg(a).then(function(d){return ug(d,c)})}
 ...
 function zg(a,b){var c=new Promise(function(d,e){og(b(a).then(function(f){a.commit();d(f)}),e)});
 return Promise.all([c,a.done]).then(function(d){return u(d).next().value})}
 yg.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new V("EXPLICIT_ABORT");};
 yg.prototype.commit=function(){var a=this.h;a.commit&&!this.aborted&&a.commit()};
 function xg(a,b){var c=a.h.objectStore(b),d=a.i.get(c);d||(d=new Cg(c),a.i.set(c,d));return d}
 function Fg(a){this.h=a}
 Fg.prototype.count=function(a){return X(this.h.count(a))};
 Fg.prototype["delete"]=function(a){return Hg(this,{query:a},function(b){return b["delete"]().then(function(){return b["continue"]()})})};
 Fg.prototype.get=function(a){return X(this.h.get(a))};
 Fg.prototype.getKey=function(a){return X(this.h.getKey(a))};
 function Hg(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return Gg(a).then(function(d){return ug(d,c)})}
 function Ig(a,b){this.request=a;this.cursor=b}
 function Gg(a){return X(a).then(function(b){return null===b?null:new Ig(a,b)})}
 p=Ig.prototype;p.advance=function(a){this.cursor.advance(a);return Gg(this.request)};
 p["continue"]=function(a){this.cursor["continue"](a);return Gg(this.request)};
 p["delete"]=function(){return X(this.cursor["delete"]()).then(function(){})};
 p.getKey=function(){return this.cursor.key};
 p.update=function(a){return X(this.cursor.update(a))};function Jg(a,b,c){return K(this,function e(){var f,g,h,k,l,m,n,r,q,x;return z(e,function(v){if(1==v.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.wa,m=g.upgrade,n=g.closed,q=function(){r||(r=new vg(f.result,{closed:n}));return r},f.addEventListener("upgradeneeded",function(w){if(null===w.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
 if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");w.dataLoss&&"none"!==w.dataLoss&&cg("IDB_DATA_CORRUPTED",{reason:w.dataLossMessage||"unknown reason",dbName:eg(a)});var N=q(),F=new yg(f.transaction);m&&m(N,w.oldVersion,w.newVersion,F)}),h&&f.addEventListener("blocked",function(){h()}),y(v,tg(f),2);
 x=v.i;k&&x.addEventListener("versionchange",function(){k(q())});
 x.addEventListener("close",function(){cg("IDB_UNEXPECTEDLY_CLOSED",{dbName:eg(a),dbVersion:x.version});l&&l()});
 return v["return"](q())})})}
 function Kg(a,b){b=void 0===b?{}:b;return K(this,function d(){var e,f,g;return z(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
 return y(h,tg(e),0)})})}
 ...
 function Og(a){return K(this,function c(){var d;return z(c,function(e){if(1==e.h)return y(e,Ng.open(),2);d=e.i;return e["return"](wg(d,["databases"],"readwrite",function(f){var g=xg(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return X(g.h.put(a,void 0)).then(function(){})})}))})})}
 function Pg(){return K(this,function b(){var c;return z(b,function(d){if(1==d.h)return y(d,Ng.open(),2);c=d.i;return d["return"](c["delete"]("databases","yt-idb-test-do-not-use"))})})}
 ;var Qg;
 function Rg(){return K(this,function b(){var c,d;return z(b,function(e){switch(e.h){case 1:var f;if(f=ef)f=/WebKit\/([0-9]+)/.exec(I),f=!!(f&&600<=parseInt(f[1],10));f&&(f=/WebKit\/([0-9]+)/.exec(I),f=!(f&&602<=parseInt(f[1],10)));if(f||xb)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(g){return e["return"](!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return e["return"](!1);e.m=2;d={actualName:"yt-idb-test-do-not-use",
 publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return y(e,Og(d),4);case 4:return y(e,Pg(),5);case 5:return e["return"](!0);case 2:return qa(e),e["return"](!1)}})})}
 function Sg(){if(void 0!==Qg)return Qg;bg=!0;return Qg=Rg().then(function(a){bg=!1;return a})}
 ;var Tg;function Ug(){Tg||(Tg=new Uf("yt.offline"));return Tg}
 ;function Vg(){M.call(this);this.s=this.u=this.C=this.l=!1;this.i=Wg();this.s=T("validate_network_status");Xg(this);Yg(this)}
 ma(Vg,M);function Wg(){var a=window.navigator.onLine;return void 0===a?!0:a}
 function Yg(a){window.addEventListener("online",function(){return K(a,function c(){var d=this;return z(c,function(e){if(1==e.h){if(!d.s){d.i=!0;e.h=2;return}return y(e,Zg(d),3)}2!=e.h&&(d.i=e.i);d.l&&d.i&&nd(d,"ytnetworkstatus-online");$g(d);if(d.u&&T("offline_error_handling")){var f=Ug().get("errors",!0);if(f){for(var g in f)if(f[g]){var h=new dg(g,"sent via offline_errors");h.name=f[g].name;h.stack=f[g].stack;h.level=f[g].level;be(h)}Ug().set("errors",{},2592E3,!0)}}e.h=0})})})}
 function Xg(a){window.addEventListener("offline",function(){return K(a,function c(){var d=this;return z(c,function(e){if(1==e.h){if(!d.s){d.i=!1;e.h=2;return}return y(e,Zg(d),3)}2!=e.h&&(d.i=e.i);d.l&&!d.i&&nd(d,"ytnetworkstatus-offline");$g(d);e.h=0})})})}
 function $g(a){a.C&&(ce(new dg("NetworkStatusManager state did not match poll",U()-0)),a.C=!1)}
 function Zg(a){return K(a,function c(){var d;return z(c,function(e){switch(e.h){case 1:return e.m=2,y(e,fetch("/generate_204",{method:"HEAD"}),4);case 4:d=!0;e.h=3;e.m=0;break;case 2:qa(e),d=!1;case 3:return e["return"](d)}})})}
 ;function ah(a){a=void 0===a?{}:a;M.call(this);var b=this;this.l=this.u=0;Vg.h||(Vg.h=new Vg);this.i=Vg.h;this.i.l=!0;a.ta&&(this.i.u=!0);a.R?(this.R=a.R,ed(this.i,"ytnetworkstatus-online",function(){bh(b,"publicytnetworkstatus-online")}),ed(this.i,"ytnetworkstatus-offline",function(){bh(b,"publicytnetworkstatus-offline")})):(ed(this.i,"ytnetworkstatus-online",function(){nd(b,"publicytnetworkstatus-online")}),ed(this.i,"ytnetworkstatus-offline",function(){nd(b,"publicytnetworkstatus-offline")}))}
 ma(ah,M);function bh(a,b){a.R?a.l?(Me(a.u),a.u=Je(function(){a.s!==b&&(nd(a,b),a.s=b,a.l=U())},a.R-(U()-a.l))):(nd(a,b),a.s=b,a.l=U()):nd(a,b)}
 ;var ch;function dh(a,b){b=void 0===b?{}:b;Sg().then(function(){ch||(ch=new ah({ta:!0}));ch.i.i!==Wg()&&ce(new dg("NetworkStatusManager isOnline does not match window status"));Ze(a,b)})}
 function eh(a,b){b=void 0===b?{}:b;Sg().then(function(){Ze(a,b)})}
 ;function fh(a){var b=this;this.h=null;a?this.h=a:Rf()&&(this.h=If());Ke(function(){Zf(b)},0,5E3)}
 fh.prototype.isReady=function(){!this.h&&Rf()&&(this.h=If());return!!this.h};
 function Lf(a,b,c,d){!R("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&ce(new dg("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new dg("innertube xhrclient not ready",b,c,d);be(e);throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
 onFetchTimeout:d.onTimeout,onSuccess:function(n,r){if(d.onSuccess)d.onSuccess(r)},
 onFetchSuccess:function(n){if(d.onSuccess)d.onSuccess(n)},
 onError:function(n,r){if(d.onError)d.onError(r)},
 onFetchError:function(n){if(d.onError)d.onError(n)},
 timeout:d.timeout,withCredentials:!0},g="";(e=a.h.pa)&&(g=e);var h=a.h.ra||!1,k=Sf(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.qa&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var m=ue(""+g+e,l||{},!0);(function(n){n=void 0===n?!1:n;var r;if(d.retry&&T("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g&&(n||(r=Xf(b,c,k,h)),r)){var q=f.onSuccess,x=f.onFetchSuccess;
 f.onSuccess=function(v,w){Yf(r);q(v,w)};
 c.onFetchSuccess=function(v,w){Yf(r);x(v,w)}}try{T("use_fetch_for_op_xhr")?We(m,f):n&&d.retry&&!d.aa.bypassNetworkless?(f.method="POST",!d.aa.writeThenSend&&T("nwl_send_fast_on_unload")?eh(m,f):dh(m,f)):(f.method="POST",f.postParams||(f.postParams={}),Ze(m,f))}catch(v){if("InvalidAccessError"==v.name)r&&(Yf(r),r=0),ce(Error("An extension is blocking network request."));
 else throw v;}r&&Ke(function(){Zf(a)},0,5E3)})(!1)}
 ;function gh(a,b){var c=void 0===c?{}:c;var d=fh;R("ytLoggingEventsDefaultDisabled",!1)&&fh==fh&&(d=null);c=void 0===c?{}:c;var e={};e.eventTimeMs=Math.round(c.timestamp||U());e[a]=b;var f=C("_lact",window);f=null==f?-1:Math.max(Date.now()-f,0);e.context={lastActivityMs:String(c.timestamp||!isFinite(f)?-1:f)};if(T("log_sequence_info_on_gel_web")&&c.da){f=e.context;var g=c.da;Mf[g]=g in Mf?Mf[g]+1:0;f.sequence={index:Mf[g],groupKey:g};c.Na&&delete Mf[c.da]}(c.Sa?Ff:Bf)({endpoint:"log_event",payload:e,
 B:c.B},d)}
 ;var hh=[{Y:function(a){return"Cannot read property '"+a.key+"'"},
 ...
 groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];function ih(){this.h=[];this.i=[]}
 var jh;function kh(){jh||(jh=new ih);return jh}
 ;var lh=new Q;function mh(a){function b(){return a.charCodeAt(d++)}
 var c=a.length,d=0;do{var e=nh(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=nh(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=nh(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
 function nh(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
 ;function oh(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=ph(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=e;var g=a[e],h=b,k=c;f="string"!==typeof g||"clickTrackingParams"!==f&&"trackingParams"!==f?0:(g=mh(atob(g.replace(/-/g,"+").replace(/_/g,"/"))))?ph(f+".ve",g,h,k):0;d+=f;d+=ph(e,a[e],b,c);if(500<d)break}}else c[b]=qh(a),d+=c[b].length;else c[b]=qh(a),d+=c[b].length;return d}
 function ph(a,b,c,d){c+="."+a;a=qh(b);d[c]=a;return c.length+a.length}
 function qh(a){return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}
 ;var rh=new Set,sh=0,th=0,uh=0,vh=[],wh=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Y(a,b,c){this.o=this.h=this.i=null;this.m=Ba(this);this.j=0;this.u=!1;this.s=[];this.l=null;this.C=c;this.D={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?ob(a.src):"https://www.youtube.com"),this.i=new De(b),c||(b=xh(this,a),this.o=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Ba(this.h)),xe[this.h.id]=this,window.postMessage){this.l=new Q;yh(this);b=S(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&
 this.addEventListener(d,b[d]);for(var e in ze)zh(this,e)}}
 p=Y.prototype;p.setSize=function(a,b){this.h.width=a;this.h.height=b;return this};
 p.ja=function(){return this.h};
 p.ca=function(a){Ah(this,a.event,a)};
 p.addEventListener=function(a,b){var c=b;"string"==typeof b&&(c=function(){window[b].apply(window,arguments)});
 if(!c)return this;this.l.subscribe(a,c);Bh(this,a);return this};
 function zh(a,b){var c=b.split(".");if(2==c.length){var d=c[1];a.C==c[0]&&Bh(a,d)}}
 ...
 p.W=function(){return{}};
 function Ch(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.u?a.U(b):a.s.push(b)}
 function Ah(a,b,c){a.l.j||(c={target:a,data:c},a.l.J(b,c),Ce(a.C+"."+b,c))}
 function xh(a,b){for(var c=document.createElement("iframe"),d=b.attributes,e=0,f=d.length;e<f;e++){var g=d[e].value;null!=g&&""!=g&&"null"!=g&&c.setAttribute(d[e].name,g)}c.setAttribute("frameBorder",0);c.setAttribute("allowfullscreen",1);c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+S(a.i,"title"));(d=S(a.i,"width"))&&c.setAttribute("width",d);(d=S(a.i,"height"))&&c.setAttribute("height",d);var h=
 ...
 function yh(a){Ee(a.i,a,a.m);a.j=me(Ga(a.ba,a));ke(a.h,"load",Ga(function(){window.clearInterval(this.j);this.j=me(Ga(this.ba,this))},a))}
 function Bh(a,b){a.D[b]||(a.D[b]=!0,Ch(a,"addEventListener",[b]))}
 ...
 void 0);var f=d||{};d="WARNING";d=void 0===d?"ERROR":d;if(e){e.level&&(d=e.level);if(T("console_log_js_exceptions")){var g=e,h=[];h.push("Name: "+g.name);h.push("Message: "+g.message);g.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(g.params));g.hasOwnProperty("args")&&h.push("Error args: "+JSON.stringify(g.args));h.push("File name: "+g.fileName);h.push("Stacktrace: "+g.stack);window.console.log(h.join("\n"),g)}if(!(5<=sh)){g=void 0;var k=f,l=Ac(e);f=l.message||"Unknown Error";h=
 l.name||"UnknownError";var m=l.stack||e.h||"Not available";if(m.startsWith(h+": "+f)){var n=m.split("\n");n.shift();m=n.join("\n")}n=l.lineNumber||"Not available";l=l.fileName||"Not available";var r=0;if(e.hasOwnProperty("args")&&e.args&&e.args.length)for(g=0;g<e.args.length&&!(r=oh(e.args[g],"params."+g,k,r),500<=r);g++);else if(e.hasOwnProperty("params")&&e.params){var q=e.params;if("object"===typeof e.params)for(g in q){if(q[g]){var x="params."+g,v=qh(q[g]);k[x]=v;r+=x.length+v.length;if(500<r)break}}else k.params=
 qh(q)}if(vh.length)for(g=0;g<vh.length&&!(r=oh(vh[g],"params.context."+g,k,r),500<=r);g++);navigator.vendor&&!k.hasOwnProperty("vendor")&&(k["device.vendor"]=navigator.vendor);g={message:f,name:h,lineNumber:n,fileName:l,stack:m,params:k,sampleWeight:1};f=Number(e.columnNumber);isNaN(f)||(g.lineNumber=g.lineNumber+":"+f);if("IGNORED"===e.level)e=0;else a:{e=kh();f=u(e.i);for(h=f.next();!h.done;h=f.next())if(h=h.value,g.message&&g.message.match(h.Oa)){e=h.weight;break a}e=u(e.h);for(f=e.next();!f.done;f=
 e.next())if(f=f.value,f.La(g)){e=f.weight;break a}e=1}g.sampleWeight=e;e=g;g=u(hh);for(f=g.next();!f.done;f=g.next())if(f=f.value,f.T[e.name])for(n=u(f.T[e.name]),h=n.next();!h.done;h=n.next())if(l=h.value,h=e.message.match(l.regexp)){e.params["params.error.original"]=h[0];n=l.groups;l={};for(m=0;m<n.length;m++)l[n[m]]=h[m+1],e.params["params.error."+n[m]]=h[m+1];e.message=f.Y(l);break}e.params||(e.params={});g=kh();e.params["params.errorServiceSignature"]="msg="+g.i.length+"&cb="+g.h.length;e.params["params.serviceWorker"]=
 "false";B.document&&B.document.querySelectorAll&&(e.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(e);if(0!==e.sampleWeight&&!rh.has(e.message)){"ERROR"===d?(lh.J("handleError",e),T("record_app_crashed_web")&&0===uh&&1===e.sampleWeight&&(uh++,gh("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),th++):"WARNING"===d&&lh.J("handleWarning",e);if(T("kevlar_gel_error_routing")){h=d;f=e;b:{g=u(wh);
 ...
 p.ca=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(D(a))for(var c in a)this.G[c]=a[c];break;case "infoDelivery":Fh(this,a);break;case "initialDelivery":window.clearInterval(this.j);this.playerInfo={};this.G={};Gh(this,a.apiInterface);Fh(this,a);break;default:Ah(this,b,a)}};
 function Fh(a,b){if(D(b))for(var c in b)a.playerInfo[c]=b[c]}
 function Gh(a,b){H(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(Date.now()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:Dh(c)?this[c]=function(){this.playerInfo={};
 this.G={};Ch(this,c,arguments);return this}:Eh(c)?this[c]=function(){var d=0;
 0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){Ch(this,c,arguments);
 return this})},a)}
 ...
 function Hh(a){if("iframe"!=a.tagName.toLowerCase()){var b=Be(a,"videoid");b&&(b={videoId:b,width:Be(a,"width"),height:Be(a,"height")},new Z(a,b))}}
 ...
 E("YT.scan",Ae);E("YT.subscribe",function(a,b,c){Gd.subscribe(a,b,c);ze[a]=!0;for(var d in xe)zh(xe[d],a)});
 ...
 "yt-player");h&&(f[d++]=b)}f.length=d;b=f}}b=Qa(b);H(Pa(a,b),Hh)});
 "undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||Ae();var Ih=B.onYTReady;Ih&&Ih();var Jh=B.onYouTubeIframeAPIReady;Jh&&Jh();var Kh=B.onYouTubePlayerAPIReady;Kh&&Kh();}).call(this);
